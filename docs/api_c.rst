...
.. Edit code_templates/api_c.rst.j2 instead; the sections below are rendered
.. from the doc comments in libwcwidth/include/wcwidth/*.h.
...
**This C11 API is a release candidate.**
...
.. c:struct:: wcwidth_align_opts_t
   ...
   .. c:member:: size_t dest_width

      target display width in cells
...
.. c:var:: const wcwidth_align_opts_t WCWIDTH_ALIGN_OPTS_DEFAULT
...
.. c:struct:: wcwidth_clip_opts_t
   ...
   .. c:member:: int tabsize
      ...
      tab stop width, 0 passes tabs through (default 8)
...
.. c:function:: static inline unsigned wcwidth_class_paged8_get(uint32_t ucs, uint32_t min, uint32_t max, unsigned shift, const uint8_t *index, const uint8_t *pool)
