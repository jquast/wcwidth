...
# libwcwidth is developed in this repository but is not part of the 0.8.4 python package release.
# To restore these pages, remove them here and re-add 'libwcwidth' and 'api_c' to the toctree of
# index.rst.  Their 7 'sphinx-build -W' warnings in api_c.rst must be resolved first.
exclude_patterns = ['libwcwidth.rst', 'api_c.rst']
