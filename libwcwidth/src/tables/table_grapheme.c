...
const size_t WCWIDTH_TABLE_GRAPHEME_EXTEND_LEN =
    sizeof(WCWIDTH_TABLE_GRAPHEME_EXTEND) / sizeof(WCWIDTH_TABLE_GRAPHEME_EXTEND[0]);
...
const size_t WCWIDTH_TABLE_GRAPHEME_L_LEN =
    sizeof(WCWIDTH_TABLE_GRAPHEME_L) / sizeof(WCWIDTH_TABLE_GRAPHEME_L[0]);
...
const size_t WCWIDTH_TABLE_GRAPHEME_V_LEN =
    sizeof(WCWIDTH_TABLE_GRAPHEME_V) / sizeof(WCWIDTH_TABLE_GRAPHEME_V[0]);
...
const size_t WCWIDTH_TABLE_GRAPHEME_T_LEN =
    sizeof(WCWIDTH_TABLE_GRAPHEME_T) / sizeof(WCWIDTH_TABLE_GRAPHEME_T[0]);
...
const size_t WCWIDTH_TABLE_GRAPHEME_LV_LEN =
    sizeof(WCWIDTH_TABLE_GRAPHEME_LV) / sizeof(WCWIDTH_TABLE_GRAPHEME_LV[0]);
...
const size_t WCWIDTH_TABLE_GRAPHEME_LVT_LEN =
    sizeof(WCWIDTH_TABLE_GRAPHEME_LVT) / sizeof(WCWIDTH_TABLE_GRAPHEME_LVT[0]);
...
const size_t WCWIDTH_TABLE_GRAPHEME_PREPEND_LEN =
    sizeof(WCWIDTH_TABLE_GRAPHEME_PREPEND) / sizeof(WCWIDTH_TABLE_GRAPHEME_PREPEND[0]);
...
const size_t WCWIDTH_TABLE_GRAPHEME_SPACINGMARK_LEN =
    sizeof(WCWIDTH_TABLE_GRAPHEME_SPACINGMARK) / sizeof(WCWIDTH_TABLE_GRAPHEME_SPACINGMARK[0]);
...
const size_t WCWIDTH_TABLE_GRAPHEME_CONTROL_LEN =
    sizeof(WCWIDTH_TABLE_GRAPHEME_CONTROL) / sizeof(WCWIDTH_TABLE_GRAPHEME_CONTROL[0]);
...
const size_t WCWIDTH_TABLE_GRAPHEME_REGIONAL_INDICATOR_LEN =
    sizeof(WCWIDTH_TABLE_GRAPHEME_REGIONAL_INDICATOR)
    / sizeof(WCWIDTH_TABLE_GRAPHEME_REGIONAL_INDICATOR[0]);
...
const size_t WCWIDTH_TABLE_EXTENDED_PICTOGRAPHIC_LEN =
    sizeof(WCWIDTH_TABLE_EXTENDED_PICTOGRAPHIC) / sizeof(WCWIDTH_TABLE_EXTENDED_PICTOGRAPHIC[0]);
...
const size_t WCWIDTH_TABLE_INCB_LINKER_LEN =
    sizeof(WCWIDTH_TABLE_INCB_LINKER) / sizeof(WCWIDTH_TABLE_INCB_LINKER[0]);
...
const size_t WCWIDTH_TABLE_INCB_CONSONANT_LEN =
    sizeof(WCWIDTH_TABLE_INCB_CONSONANT) / sizeof(WCWIDTH_TABLE_INCB_CONSONANT[0]);
...
const size_t WCWIDTH_TABLE_INCB_EXTEND_LEN =
    sizeof(WCWIDTH_TABLE_INCB_EXTEND) / sizeof(WCWIDTH_TABLE_INCB_EXTEND[0]);
