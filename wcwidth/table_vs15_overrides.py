...
# For terminals: alacritty, apple_terminal, contour, extraterm, gnu screen, iterm2, konsole, libvterm, mlterm, pterm, st-luke, terminology, tmux, urxvt, vte, wezterm, xterm, xterm.js, zellij
_SET_CE924F3D = {
    'narrower': (
    ),
    'wider': (
