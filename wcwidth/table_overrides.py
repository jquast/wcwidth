...
_SET_WIDE_OVERRIDES_75F0F88B: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
...
_SET_WIDE_OVERRIDES_28D325F5: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
...
_SET_WIDE_OVERRIDES_E511735F: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
...
# For terminals: foot
_SET_WIDE_OVERRIDES_55CD072D: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x0fa6e, 0x0fa6f,),  # (nil)
        (0x0fada, 0x0faff,),  # (nil)
        (0x1f1e6, 0x1f1ff,),  # Regional Indicator Symbo..Regional Indicator Symbo
...
# For terminals: ghostty
_SET_WIDE_OVERRIDES_BE04159D: dict[str, tuple[tuple[int, int], ...]] = {
    'zeroer': (
...
_SET_WIDE_OVERRIDES_8174F396: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x1f6d8, 0x1f6d8,),  # Landslide
...
# For terminals: kitty
_SET_WIDE_OVERRIDES_2E7D8C29: dict[str, tuple[tuple[int, int], ...]] = {
    'zeroer': (
        (0x1f3fb, 0x1f3ff,),  # Emoji Modifier Fitzpatri..Emoji Modifier Fitzpatri
    ),
}
...
_SET_WIDE_OVERRIDES_8BB7801B: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x02630, 0x02637,),  # Trigram For Heaven      ..Trigram For Earth
        (0x0268a, 0x0268f,),  # Monogram For Yang       ..Digram For Greater Yin
        (0x02ffc, 0x02fff,),  # Ideographic Description ..Ideographic Description
...
_SET_WIDE_OVERRIDES_2270DDA3: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x02630, 0x02637,),  # Trigram For Heaven      ..Trigram For Earth
        (0x0268a, 0x0268f,),  # Monogram For Yang       ..Digram For Greater Yin
        (0x031e4, 0x031e5,),  # Cjk Stroke Hxg          ..Cjk Stroke Szp
...
_SET_WIDE_OVERRIDES_0AC3A852: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x1f1e6, 0x1f1ff,),  # Regional Indicator Symbo..Regional Indicator Symbo
        (0x1f6d8, 0x1f6d8,),  # Landslide
        (0x1fa8a, 0x1fa8a,),  # Trombone
...
_SET_WIDE_OVERRIDES_C5E981EF: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x0fa6e, 0x0fa6f,),  # (nil)
        (0x0fada, 0x0faff,),  # (nil)
        (0x1f1e6, 0x1f1ff,),  # Regional Indicator Symbo..Regional Indicator Symbo
...
_SET_WIDE_OVERRIDES_79B92419: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x02630, 0x02637,),  # Trigram For Heaven      ..Trigram For Earth
        (0x0268a, 0x0268f,),  # Monogram For Yang       ..Digram For Greater Yin
        (0x04dc0, 0x04dff,),  # Hexagram For The Creativ..Hexagram For Before Comp
...
_SET_WIDE_OVERRIDES_3FFB129E: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x02630, 0x02637,),  # Trigram For Heaven      ..Trigram For Earth
        (0x0268a, 0x0268f,),  # Monogram For Yang       ..Digram For Greater Yin
        (0x02ffc, 0x02fff,),  # Ideographic Description ..Ideographic Description
...
_SET_WIDE_OVERRIDES_9E30C27D: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x02630, 0x02637,),  # Trigram For Heaven      ..Trigram For Earth
        (0x0268a, 0x0268f,),  # Monogram For Yang       ..Digram For Greater Yin
        (0x02ffc, 0x02fff,),  # Ideographic Description ..Ideographic Description
...
WIDE_OVERRIDES: dict[str, dict[str, tuple[tuple[int, int], ...]]] = {
    'alacritty': _SET_WIDE_OVERRIDES_75F0F88B,
    'apple_terminal': _SET_WIDE_OVERRIDES_75F0F88B,
    'bobcat': _SET_WIDE_OVERRIDES_28D325F5,
    'extraterm': _SET_WIDE_OVERRIDES_E511735F,
    'foot': _SET_WIDE_OVERRIDES_55CD072D,
    'ghostty': _SET_WIDE_OVERRIDES_BE04159D,
    'iterm2': _SET_WIDE_OVERRIDES_8174F396,
    'kitty': _SET_WIDE_OVERRIDES_2E7D8C29,
    'konsole': _SET_WIDE_OVERRIDES_8BB7801B,
    'mintty': _SET_WIDE_OVERRIDES_8BB7801B,
    'mlterm': _SET_WIDE_OVERRIDES_2270DDA3,
    'pterm': _SET_WIDE_OVERRIDES_0AC3A852,
    'rio': _SET_WIDE_OVERRIDES_0AC3A852,
    'st': _SET_WIDE_OVERRIDES_C5E981EF,
    'terminology': _SET_WIDE_OVERRIDES_79B92419,
    'urxvt': _SET_WIDE_OVERRIDES_C5E981EF,
    'vte': _SET_WIDE_OVERRIDES_3FFB129E,
    'warp': _SET_WIDE_OVERRIDES_2270DDA3,
    'wezterm': _SET_WIDE_OVERRIDES_3FFB129E,
    'xterm': _SET_WIDE_OVERRIDES_C5E981EF,
    'xterm.js': _SET_WIDE_OVERRIDES_9E30C27D,
}
...
_SET_SRI_OVERRIDES_75F0F88B: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x1f1e6, 0x1f1ff,),  # Regional Indicator Symbo..Regional Indicator Symbo
    ),
}
...
SRI_OVERRIDES: dict[str, dict[str, tuple[tuple[int, int], ...]]] = {
    'alacritty': _SET_SRI_OVERRIDES_75F0F88B,
    'apple_terminal': _SET_SRI_OVERRIDES_75F0F88B,
    'extraterm': _SET_SRI_OVERRIDES_75F0F88B,
    'foot': _SET_SRI_OVERRIDES_75F0F88B,
    'mlterm': _SET_SRI_OVERRIDES_75F0F88B,
    'pterm': _SET_SRI_OVERRIDES_75F0F88B,
    'rio': _SET_SRI_OVERRIDES_75F0F88B,
    'st': _SET_SRI_OVERRIDES_75F0F88B,
    'terminology': _SET_SRI_OVERRIDES_75F0F88B,
    'urxvt': _SET_SRI_OVERRIDES_75F0F88B,
    'vte': _SET_SRI_OVERRIDES_75F0F88B,
    'warp': _SET_SRI_OVERRIDES_75F0F88B,
    'wezterm': _SET_SRI_OVERRIDES_75F0F88B,
    'xterm': _SET_SRI_OVERRIDES_75F0F88B,
    'xterm.js': _SET_SRI_OVERRIDES_75F0F88B,
}

# For terminals: bobcat, kitty
_SET_SFZ_OVERRIDES_2E7D8C29: dict[str, tuple[tuple[int, int], ...]] = {
    'zeroer': (
        (0x1f3fb, 0x1f3ff,),  # Emoji Modifier Fitzpatri..Emoji Modifier Fitzpatri
    ),
}
...
# For terminals: foot
_SET_SFZ_OVERRIDES_D82CDBD7: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x1f3fb, 0x1f3ff,),  # Emoji Modifier Fitzpatri..Emoji Modifier Fitzpatri
    ),
}
...
SFZ_OVERRIDES: dict[str, dict[str, tuple[tuple[int, int], ...]]] = {
    'bobcat': _SET_SFZ_OVERRIDES_2E7D8C29,
    'foot': _SET_SFZ_OVERRIDES_D82CDBD7,
    'kitty': _SET_SFZ_OVERRIDES_2E7D8C29,
}

# For terminals: alacritty, apple_terminal, contour, mlterm, pterm, st, terminology, urxvt, vte, wezterm, xterm, xterm.js
_SET_VS16_OVERRIDES_1988E6D7: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
...
# For terminals: iterm2
_SET_VS16_OVERRIDES_1C610F19: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x00023, 0x00023,),  # Number Sign
        (0x0002a, 0x0002a,),  # Asterisk
        (0x00030, 0x00039,),  # Digit Zero              ..Digit Nine
...
VS16_OVERRIDES: dict[str, dict[str, tuple[tuple[int, int], ...]]] = {
    'alacritty': _SET_VS16_OVERRIDES_1988E6D7,
    'apple_terminal': _SET_VS16_OVERRIDES_1988E6D7,
    'contour': _SET_VS16_OVERRIDES_1988E6D7,
    'iterm2': _SET_VS16_OVERRIDES_1C610F19,
    'mlterm': _SET_VS16_OVERRIDES_1988E6D7,
    'pterm': _SET_VS16_OVERRIDES_1988E6D7,
    'st': _SET_VS16_OVERRIDES_1988E6D7,
    'terminology': _SET_VS16_OVERRIDES_1988E6D7,
    'urxvt': _SET_VS16_OVERRIDES_1988E6D7,
    'vte': _SET_VS16_OVERRIDES_1988E6D7,
    'wezterm': _SET_VS16_OVERRIDES_1988E6D7,
    'xterm': _SET_VS16_OVERRIDES_1988E6D7,
    'xterm.js': _SET_VS16_OVERRIDES_1988E6D7,
}
...
_SET_VS15_OVERRIDES_72C017E3: dict[str, tuple[tuple[int, int], ...]] = {
    'wider': (
...
# For terminals: bobcat
_SET_VS15_OVERRIDES_65682F9C: dict[str, tuple[tuple[int, int], ...]] = {
    'wider': (
        (0x03030, 0x03030,),  # Wavy Dash
        (0x0303d, 0x0303d,),  # Part Alternation Mark
        (0x03297, 0x03297,),  # Circled Ideograph Congratulation
...
# For terminals: rio
_SET_VS15_OVERRIDES_D53FF224: dict[str, tuple[tuple[int, int], ...]] = {
    'wider': (
...
# For terminals: warp
_SET_VS15_OVERRIDES_F136BF31: dict[str, tuple[tuple[int, int], ...]] = {
    'wider': (
        (0x0231a, 0x0231b,),  # Watch                   ..Hourglass
        (0x023e9, 0x023ec,),  # Black Right-pointing Dou..Black Down-pointing Doub
        (0x023f0, 0x023f0,),  # Alarm Clock
...
VS15_OVERRIDES: dict[str, dict[str, tuple[tuple[int, int], ...]]] = {
    'alacritty': _SET_VS15_OVERRIDES_72C017E3,
    'apple_terminal': _SET_VS15_OVERRIDES_72C017E3,
    'bobcat': _SET_VS15_OVERRIDES_65682F9C,
    'contour': _SET_VS15_OVERRIDES_72C017E3,
    'extraterm': _SET_VS15_OVERRIDES_72C017E3,
    'iterm2': _SET_VS15_OVERRIDES_72C017E3,
    'konsole': _SET_VS15_OVERRIDES_72C017E3,
    'mlterm': _SET_VS15_OVERRIDES_72C017E3,
    'pterm': _SET_VS15_OVERRIDES_72C017E3,
    'rio': _SET_VS15_OVERRIDES_D53FF224,
    'st': _SET_VS15_OVERRIDES_72C017E3,
    'terminology': _SET_VS15_OVERRIDES_72C017E3,
    'urxvt': _SET_VS15_OVERRIDES_72C017E3,
    'vte': _SET_VS15_OVERRIDES_72C017E3,
    'warp': _SET_VS15_OVERRIDES_F136BF31,
    'wezterm': _SET_VS15_OVERRIDES_72C017E3,
    'xterm': _SET_VS15_OVERRIDES_72C017E3,
    'xterm.js': _SET_VS15_OVERRIDES_72C017E3,
}
