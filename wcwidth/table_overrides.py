...
# For terminals: foot
_SET_WIDE_OVERRIDES_46612890: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x0fa6e, 0x0fa6f,),  # (nil)
        (0x0fada, 0x0faff,),  # (nil)
        (0x1f1e6, 0x1f1ff,),  # Regional Indicator Symbo..Regional Indicator Symbo
...
_SET_WIDE_OVERRIDES_17DBC3AE: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x1f6d8, 0x1f6d8,),  # Landslide
...
_SET_WIDE_OVERRIDES_145916FE: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x0fa6e, 0x0fa6f,),  # (nil)
        (0x0fada, 0x0faff,),  # (nil)
        (0x1f1e6, 0x1f1ff,),  # Regional Indicator Symbo..Regional Indicator Symbo
...
_SET_WIDE_OVERRIDES_05D9A9B0: dict[str, tuple[tuple[int, int], ...]] = {
    'narrower': (
        (0x02630, 0x02637,),  # Trigram For Heaven      ..Trigram For Earth
        (0x0268a, 0x0268f,),  # Monogram For Yang       ..Digram For Greater Yin
        (0x02ffc, 0x02fff,),  # Ideographic Description ..Ideographic Description
...
WIDE_OVERRIDES: dict[str, dict[str, tuple[tuple[int, int], ...]]] = {
    ...
    'foot': _SET_WIDE_OVERRIDES_46612890,
    'ghostty': _SET_WIDE_OVERRIDES_CF30CE25,
    'iterm2': _SET_WIDE_OVERRIDES_17DBC3AE,
    'kitty': _SET_WIDE_OVERRIDES_73E5B60D,
    'konsole': _SET_WIDE_OVERRIDES_25894E07,
    'mintty': _SET_WIDE_OVERRIDES_25894E07,
    'mlterm': _SET_WIDE_OVERRIDES_D289A768,
    'pterm': _SET_WIDE_OVERRIDES_243C8ED7,
    'rio': _SET_WIDE_OVERRIDES_243C8ED7,
    'st': _SET_WIDE_OVERRIDES_145916FE,
    'terminology': _SET_WIDE_OVERRIDES_C908F105,
    'urxvt': _SET_WIDE_OVERRIDES_145916FE,
    'vte': _SET_WIDE_OVERRIDES_05D9A9B0,
    'warp': _SET_WIDE_OVERRIDES_D289A768,
    'wezterm': _SET_WIDE_OVERRIDES_05D9A9B0,
    'xterm': _SET_WIDE_OVERRIDES_145916FE,
